...
import { Activity, Users, Target, TrendingUp, Calendar, Clock, BarChart3, Shield } from 'lucide-react';
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen p-6">
      ...
      >
        <div className="card-cyber p-6 hover:border-primary/40 transition-all duration-300">
        ...
        <div className="card-cyber p-6 hover:border-secondary/40 transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center mt-2">
            <TrendingUp className="w-4 h-4 text-secondary mr-1" />
            <span className="text-secondary text-sm">+5% improvement</span>
          </div>
        </div>

        <div className="card-cyber p-6 hover:border-accent/40 transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-sm text-gray-400">Average Daily Training</div>
          <div className="flex items-center mt-2">
            <TrendingUp className="w-4 h-4 text-secondary mr-1" />
            <span className="text-secondary text-sm">+0.3h increase</span>
          </div>
        </div>
        ...
        <div className="card-cyber p-6 hover:border-primary/40 transition-all duration-300">
          ...
          <div className="text-sm text-gray-400">Performance Index</div>
          <div className="flex items-center mt-2">
            <TrendingUp className="w-4 h-4 text-secondary mr-1" />
            <span className="text-secondary text-sm">Elite level</span>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <div className="card-cyber p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-white text-sm">{user?.id?.slice(-8) || 'Loading...'}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-400">Email</span>
                <span className="text-white text-sm">{user?.email || 'Loading...'}</span>
              </div>
              <div className="flex items-center justify-between">
          ...
          <div className="card-cyber p-6">
            ...
            <div className="space-y-3">
              <button className="w-full btn-cyber py-3 text-sm">
                <Activity className="w-4 h-4 mr-2" />
                Start New Session
              </button>
              <button className="w-full p-3 rounded-lg glass-effect hover:border-primary/30 transition-all duration-300 text-white text-sm">
                <Target className="w-4 h-4 mr-2 inline" />
                View Training Plans
              </button>
              <button className="w-full p-3 rounded-lg glass-effect hover:border-secondary/30 transition-all duration-300 text-white text-sm">
